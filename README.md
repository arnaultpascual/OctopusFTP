...
### Main Interface
The main window features a split view with remote file browser on the left and active downloads on the right.

### Connection Management
Save and manage multiple FTP server connections with optional password storage.
